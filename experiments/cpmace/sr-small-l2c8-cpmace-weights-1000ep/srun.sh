#!/bin/bash
#SBATCH --job-name=cpmace-sr-l2c8-cpw-1000ep
...
# lorem-wf, not lorem313: this trains on the work function, which needs
# lorem.LoremQ -- it only exists in the charge-conditioning build.
