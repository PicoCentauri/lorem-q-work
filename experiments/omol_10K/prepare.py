...
train_data = [rename_charge(a) for a in read(f"{DATA}/omol_small_train.xyz", index=":")]
valid_data = [rename_charge(a) for a in read(f"{DATA}/omol_small_val.xyz", index=":")]
test_data = [rename_charge(a) for a in read(f"{DATA}/omol_small_test.xyz", index=":")]
