...
DATA = "../../datasets/water_external_field"
...
train_data = [rename_keys(a) for a in read(f"{DATA}/water_external_field_train.xyz", index=":")]
valid_data = [rename_keys(a) for a in read(f"{DATA}/water_external_field_val.xyz", index=":")]
test_data = [rename_keys(a) for a in read(f"{DATA}/water_external_field_test.xyz", index=":")]
